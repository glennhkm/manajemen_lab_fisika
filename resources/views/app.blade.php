<x-layout-app>
    ...
    <section id="hero" class="w-full h-screen flex relative border-b border-[#27548A]/30">
        ...
        <div class="absolute inset-0 bg-gradient-to-bl from-black/80 to-[#27548A]/40 w-full h-full z-10 backdrop-blur"></div>
        <div class="w-full h-full text-neutral_01 flex flex-col items-center justify-center z-20 px-6 md:px-12 gap-4">
            ...
            <div id="contribution"
                class="bg-neutral_01 backdrop-blur border border-[#27548A]/60 grid grid-cols-3 px-4 md:grid-cols-3 gap-x-12 md:gap-x-32 gap-y-4 md:gap-32 absolute -bottom-[3.8rem] justify-between w-full md:w-auto items-center py-6 rounded-3xl shadow-lg shadow-black/20"
                data-aos="fade-up" data-aos-duration="300">
                <div class="flex gap-2 flex-col md:gap-4 items-center text-center">
                    <h4 class="font-bold text-xl md:text-4xl text-[#27548A]">23+</h4>
                ...
                <div class="flex flex-col gap-2 md:gap-4 items-center text-center">
                    <h4 class="font-bold text-xl md:text-4xl text-yellow-400">100+</h4>
    ...
    <section id="about" class="section-padding bg-gradient-to-br from-[#27548A]/40 via-transparent to-transparent">
        <div class="container mx-auto px-6 md:px-12 pt-12">
            <div class="text-center mb-16" data-aos="fade-up">
                <h2 class="text-5xl md:text-6xl font-bold mb-8 text-[#151515]/90">
